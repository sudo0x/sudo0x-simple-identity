...
{{- include "identity-service.fullname" . }}-config
{{- end }}

{{/*
Name of the Secret (chart-managed or existing)
*/}}
{{- define "identity-service.secretName" -}}
{{- if .Values.secret.existingSecret }}
{{- .Values.secret.existingSecret }}
{{- else }}
{{- include "identity-service.fullname" . }}-secrets
{{- end }}
{{- end }}

{{/*
Return true if a chart-managed Secret should be created
*/}}
{{- define "identity-service.createSecret" -}}
{{- if not .Values.secret.existingSecret }}true{{- end }}
{{- end }}

{{/*
Return the image reference string
*/}}
{{- define "identity-service.image" -}}
